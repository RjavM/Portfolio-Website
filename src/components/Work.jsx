...
const works = [{
    ...
    description: ["-> Collaborating with a professor on advanced AI/ML research, specializing in object tracking and computer vision.",
...
export const Work = () => {
    return <div className="bg-gray-900 flex flex-col min-h-screen">
        <Navbar />
            <div id="projects" className="text-white py-20 px-10 mb-10">
                <h2 className="text-3xl font-bold">Work Experience...</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-10">
                    {works.map((work, index) => (
                        <div key={index} className="text-black bg-gray-300 p-5 rounded-lg shadow-lg">
                            <h3 className="text-xl font-bold">{work.title}</h3>
                            <div className="mt-2">{work.description.map((line, i) => (
